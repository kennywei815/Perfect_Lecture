...
Sub InitializeApp()
    ...
    AddMenuItem "New/Edit LaTeX Display...", "EditLaTeX", 1
    AddMenuItem "Insert/Change Image...", "InsertPicture", 1
    
#If PLATFORM = PowerPoint Then
    AddMenuItem "Compile with Perfect Lecture", "SaveAsMP4", 1
#End If
...
Sub UnInitializeApp()
    ...
    RemoveMenuItem "Compile with Perfect Lecture"
